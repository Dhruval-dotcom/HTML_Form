...
document.getElementById('postal').innerHTML=localStorage.getItem("postal");
...
if(dept.indexOf('2')!=-1)
    document.getElementById('golang').checked=true;
...
document.getElementById('vehicle').innerHTML=localStorage.getItem('vehicle');
...
blood_group.value = localStorage.getItem('blood-group');
